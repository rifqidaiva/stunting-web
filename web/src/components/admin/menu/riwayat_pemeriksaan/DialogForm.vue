...
const fetchBalitaOptions = async () => {
  ...
  try {
    ...
    balitaOptions.value = response.data.data
...
const fetchIntervensiOptions = async () => {
  ...
  try {
    ...
    intervensiOptions.value = response.data.data
...
const fetchLaporanOptions = async () => {
  ...
  try {
    ...
    laporanOptions.value = response.data.data
...
const validateForm = (): boolean => {
  ...
  if (!formData.value.id_intervensi) {
    errors.value.id_intervensi = "Intervensi harus dipilih"
  }

  // Laporan validation
  if (!formData.value.id_laporan_masyarakat) {
  ...
  if (!formData.value.berat_badan) {
    ...
    const berat = parseFloat(formData.value.berat_badan)
  ...
  if (!formData.value.tinggi_badan) {
    ...
    const tinggi = parseFloat(formData.value.tinggi_badan)
