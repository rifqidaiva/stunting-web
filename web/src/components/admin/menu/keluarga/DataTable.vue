...
import { ChevronDown, Search, Check, Eye, EyeOff } from "lucide-vue-next"
...
import { columns, type Keluarga } from "./columns"
...
const searchValue = computed({
  get: () => (table.getColumn("nama_ayah")?.getFilterValue() as string) ?? "",
  set: (value) => table.getColumn("nama_ayah")?.setFilterValue(value),
})
...
<template>
  <div class="w-full">
    <div class="flex items-center py-4 gap-4">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent
          ...
          <!-- Using DropdownMenuCheckboxItem (Default shadcn way) -->
          <DropdownMenuCheckboxItem
    ...
    <div
      ...
      <!-- <div class="flex-1 text-sm text-muted-foreground text-center md:text-left">
