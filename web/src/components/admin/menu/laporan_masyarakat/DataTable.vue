...
import { columns, type LaporanMasyarakat } from "./columns"
...
const searchNamaPelapor = computed({
  get: () => (table.getColumn("nama_pelapor")?.getFilterValue() as string) || "",
  set: (value) => {
    table.getColumn("nama_pelapor")?.setFilterValue(value)
  }
})
