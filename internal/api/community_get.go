...
// CommunityGet handles the retrieval of reports by masyarakat (community members).
func CommunityGet(w http.ResponseWriter, r *http.Request) {
	...
	WHERE l.id_pengguna = ? AND l.deleted_date IS NULL`
